...
3) Access the `workbench` named `mar12-ragoldappnewimage-1-notebook`.
...
5) In the terminal, run `cd mar12-ragoldappnewimage-1` to navigate to your sample app's directory.
